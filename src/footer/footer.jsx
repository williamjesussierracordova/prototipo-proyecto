            ...
            <div className="sb__footer section__padding">
                <div className="sb__footer-links">
                    ...
                    <div className="sb__footer-links_div">
                        ...
                        <div className="socialmedia">
                            ...
                            <a href="https://www.facebook.com/GranTeatroNacional/" target="_blank">
                                <CiFacebook className="icon"/>
                            </a>
                            <a href="https://twitter.com/GranTeatroNac" target="_blank">
                                <FaXTwitter className="icon"/>
                            </a>
                            <a href="https://www.instagram.com/granteatronacional/" target="_blank">
                                <FaInstagram className="icon"/>
                            </a>
                            <a href="https://www.youtube.com/channel/UCxKysdVSHGO3t0YJF5Dj4_w/featured" target="_blank">
                ...
                <div className="sb__footer-below">
                    ...
                    <div className="sb__footer-below-links">
                        <a href="/terms"><div><Link to={"/"}><p>GRAN TEATRO NACIONAL - MINISTERIO DE CULTURA</p></Link></div></a>
                    </div>
                </div>
            </div>
        </div>
